...
```bash
git tag 0.18.5
git push origin 0.18.5
```

Open `https://jitpack.io/#elivity/flow-graph`, select `0.18.5`, and click **Get it** once if you want to force the first build immediately. Otherwise the first Gradle dependency request triggers it.
...
`com.github.elivity:flow-graph:0.18.5`

package com.oskiapps.flowgraph.action
...
class ShowFlowGraphAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        ReadAction.nonBlocking<com.oskiapps.flowgraph.model.FlowGraph> {
            val current = pointer.element
                ?: return@nonBlocking com.oskiapps.flowgraph.model.FlowGraph(
                    rootLabel = "No Flow",
                    nodes = emptyList(),
                    edges = emptyList(),
